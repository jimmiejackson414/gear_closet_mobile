...
const createIconUI = ({ ...props }: ParameterTypes) => {
  ...
  const ForwardedIcon = React.forwardRef<React.ElementRef<typeof Svg>>(
    (
      {
        className,
        size,
  ...
  ForwardedIcon.displayName = 'UIIconCreateIcon';
...
export {
  ArrowUpIcon, ArrowDownIcon, ArrowRightIcon, ArrowLeftIcon,
};
