...
const DialogOverlayNative = forwardRef<
        ...
        <SafeAreaView
          ...
          <DialogPrimitive.Content
            className={cn(
              ...
              fullScreen && 'w-full min-w-full h-full m-0 rounded-2xl items-center justify-center',
              className,
            )}
            ref={ref}
            {...props}>
...
const DialogFooter = ({ className, ...props }: ViewProps) => (
  <View
    className={cn('flex flex-col-reverse sm:flex-row sm:justify-end gap-2 mt-8', className)}
    {...props} />
);
